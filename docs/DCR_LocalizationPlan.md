...
| Phase                 | Work                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Risk                                                                                                                                           |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| 1                     | Sweep remaining hardcoded Java strings into `values/strings.xml` (`AboutDialog`, `CategorySelectionPolicy`, `CsvImporter`/`CsvExportResult` messages, the leftover dev toast). Include the new About-dialog translation feedback paragraph with translation/support email contact strings. Also pre-populate `values-fr/strings.xml` with resource-mapped equivalents of currently working hardcoded French terms used in `DaysSinceCalculations` as a behavior-preservation bridge before Phase 2 branch removal. No behavior change. | Low — mechanical, additive                                                                                                                     |
...
10. **Feedback channels in About dialog:** add a paragraph with `mailto:` links for translation feedback and general support.
...
Suggested contact copy for About dialog:

"If you wish to provide language translation feedback, email translation@merware.com. For general app comments or questions, email support@merware.com."
